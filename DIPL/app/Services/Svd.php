        ...
        for($i = 0; $i < $n; $i++){
            ...
            if($i < $m){
                ...
                if($scale != 0.0) {
                    ...
                    $U[$i][$i] = $f - $g;
                    for($j = $l - 1; $j < $n; $j++){
                        for($s = 0.0, $k = $i; $k < $m; $k++) $s += floatval($U[$k][$i]) * floatval($U[$k][$j]);
                        $f = $s / $h;

                        for($k = $i; $k < $m; $k++){
                            $U[$k][$j] = floatval($U[$k][$j]);
                            $U[$k][$j] += floatval($f) * floatval($U[$k][$i]);
                        }
                    }
